 ...
 * @brief Uçuş Kontrolcüsü — ROS2 Topic tabanlı MAVLink köprü arayüzü
 *
 * mavlink_bridge.py ile haberleşir:
 *   Komutlar → /mavlink/cmd/* topic'lerine JSON yayınlar
 *   Telemetri ← /mavlink/telemetry topic'inden JSON okur
 */
#pragma once
...
private:
    ...
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr pub_takeoff_;
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr pub_land_;
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr pub_goto_;
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr pub_velocity_;
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr pub_yaw_;
